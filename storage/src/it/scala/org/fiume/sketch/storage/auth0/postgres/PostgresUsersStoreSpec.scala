      ...
      will(cleanStorage) {
        ...
        PostgresUsersStore.make[IO](transactor(), frozenTime).use { store =>
          ...
          yield
            ...
            assertEquals(
              fstAccountDeletionJob, // ignore checking the job id generated by Postgres
              PermanentAccountDeletionJob(fstAccountDeletionJob.uuid, fstUserId, permanentDeletionAt)
            )
