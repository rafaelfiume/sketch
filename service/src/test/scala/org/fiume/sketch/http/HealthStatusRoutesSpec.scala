...
import org.fiume.sketch.shared.common.app.{HealthChecker, ServiceStatus, Version, Versions}
import org.fiume.sketch.shared.common.app.ServiceStatus.{Dependency, DependencyStatus, *}
